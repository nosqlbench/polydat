...
fn __u64_to_u128(n: u64) -> u128 {
    n as u128
}

#[crate::polydat_node(category = Conversions)]
fn __u64_to_i128(n: u64) -> i128 {
    n as i128
}

#[crate::polydat_node(category = Conversions)]
fn __i64_to_i128(n: i64) -> i128 {
    n as i128
}

#[crate::polydat_node(category = Conversions)]
fn __u128_to_f64(n: u128) -> f64 {
    n as f64
}

#[crate::polydat_node(category = Conversions)]
fn __i128_to_f64(n: i128) -> f64 {
    n as f64
}
...
#[crate::polydat_node(category = Conversions)]
fn __u8_to_u128(n: u8) -> u128 {
    n as u128
}

#[crate::polydat_node(category = Conversions)]
fn __u8_to_i128(n: u8) -> i128 {
    n as i128
}

#[crate::polydat_node(category = Conversions)]
fn __u16_to_u128(n: u16) -> u128 {
    n as u128
}

#[crate::polydat_node(category = Conversions)]
fn __u16_to_i128(n: u16) -> i128 {
    n as i128
}

#[crate::polydat_node(category = Conversions)]
fn __u32_to_u128(n: u32) -> u128 {
    n as u128
}

#[crate::polydat_node(category = Conversions)]
fn __u32_to_i128(n: u32) -> i128 {
    n as i128
}

#[crate::polydat_node(category = Conversions)]
fn __i8_to_i128(n: i8) -> i128 {
    n as i128
}

#[crate::polydat_node(category = Conversions)]
fn __i16_to_i128(n: i16) -> i128 {
    n as i128
}

#[crate::polydat_node(category = Conversions)]
fn __i32_to_i128(n: i32) -> i128 {
    n as i128
}

#[crate::polydat_node(category = Conversions)]
fn __bool_to_u128(b: bool) -> u128 {
    b as u128
}

#[crate::polydat_node(category = Conversions)]
fn __bool_to_i128(b: bool) -> i128 {
    b as i128
}

#[crate::polydat_node(category = Conversions)]
fn __u128_to_bool(n: u128) -> bool {
    n != 0
}

#[crate::polydat_node(category = Conversions)]
fn __i128_to_bool(n: i128) -> bool {
    n != 0
}
...
fn __i128_to_i64(n: i128) -> i64 {
    if n < i64::MIN as i128 || n > i64::MAX as i128 {
        panic!(
            "__i128_to_i64: value {n} out of i64 range [{}, {}]",
            i64::MIN,
            i64::MAX
        );
    }
...
fn __u128_to_i128(n: u128) -> i128 {
    if n > i128::MAX as u128 {
        panic!(
            "__u128_to_i128: value {n} exceeds i128::MAX ({})",
            i128::MAX
        );
    }
    n as i128
...
#[crate::polydat_node(category = Conversions)]
fn __u128_to_string(n: u128) -> String {
    n.to_string()
}

#[crate::polydat_node(category = Conversions)]
fn __i128_to_string(n: i128) -> String {
    n.to_string()
}
...
#[crate::polydat_node(category = Conversions)]
fn __u128_to_bytes(n: u128) -> Vec<u8> {
    n.to_le_bytes().to_vec()
}

#[crate::polydat_node(category = Conversions)]
fn __i128_to_bytes(n: i128) -> Vec<u8> {
    n.to_le_bytes().to_vec()
}
...
fn __bytes_to_u128(b: &[u8]) -> u128 {
    if b.len() != 16 {
        panic!(
            "__bytes_to_u128: expected exactly 16 bytes for u128, got {}",
            b.len()
        );
    }
...
fn __bytes_to_i128(b: &[u8]) -> i128 {
    if b.len() != 16 {
        panic!(
            "__bytes_to_i128: expected exactly 16 bytes for i128, got {}",
            b.len()
        );
    }
...
fn __json_to_u128(j: &serde_json::Value) -> u128 {
    match j {
        serde_json::Value::String(s) => s
            .trim()
            .parse::<u128>()
            .unwrap_or_else(|e| panic!("__json_to_u128: cannot parse {s:?} as u128: {e}")),
...
fn __json_to_i128(j: &serde_json::Value) -> i128 {
    match j {
        serde_json::Value::String(s) => s
            .trim()
            .parse::<i128>()
            .unwrap_or_else(|e| panic!("__json_to_i128: cannot parse {s:?} as i128: {e}")),
        serde_json::Value::Number(n) => n
            .as_i64()
            .map(|i| i as i128)
...
mod tests {
    ...
    fn u128v(v: u128) -> Value {
        Value::U128(Bits128::from_u128(v))
    }
    fn i128v(v: i128) -> Value {
        Value::I128(Bits128::from_i128(v))
    }
