...
//! polydat-core's `PolydatKernelScope` (`surfaces/polydat_kernel.rs`)
//! implements it over a `PolydatKernel` pair; tests can implement
//! it with a lightweight mock so the surfaces can be exercised
