...
Pure native code, the differential tier behind P3, has no lowering for these 127 nodes, which P3 runs as closure steps:

`is_stable`, `idx_of`, `mod_in`, `at`, `partition_at`, `partitions`, `subdivide`, `cardinality`, `start_of`, `random_in`, `end_of`, `clamp_in`, `partition_count`, `count_of`, `weighted_strings`, `dynamic_weighted_select`, `weighted_u64`, `streamer`, `alias_sample`, `histribution`, `reg_dot_f32`, `reg_shuffle_bytes`, `reg_lane_i64`, `reg_lane_i16`, `reg_mul_i8`, `reg_with_lane_f32`, `reg_lane_f32`, `reg_gather_f32`, `vec_to_reg_f32`, `reg_to_vec_f32`, `url_decode`, `html_encode`, `url_encode`, `html_decode`, `date_components`, `to_timestamp`, `jsonl_row_count`, `csv_row`, `jsonl_field`, `csv_field`, `csv_row_count`, `jsonl_row`, `format_u64`, `zero_pad_u64`, `format_f64`, `limit`, `elapsed_millis`, `counter`, `env_or`, `env`, `tmp_dir`, `str_eq`, `str_ne`, `select_str`, `byte_slice`, `from_hex`, `to_hex`, `bytes_from_hash`, `u64_to_bytes`, `char_image_extract`, `byte_image_extract`, `file_line_at`, `number_to_words`, `combinations`, `file_line_at`, `str_concat`, `char_buf`, `hashed_uuid`, `random_f64`, `random_bytes`, `hashed_lorem_extract`, `random_range`, `random_bool`, `random_string`, `hashed_line_to_string`, `sha256`, `to_base64`, `to_base32`, `md5`, `from_base64`, `from_base32`, `regex_replace`, `regex_replace`, `regex_extract`, `pattern_match`, `regex_match`, `fixed_values_u64`, `fixed_values_str`, `fixed_values_f64`, `pick`, `escape_json`, `array_at`, `normalize_vector`, `json_field`, `json_with`, `random_vector`, `json_to_str_pretty`, `array_len`, `json_merge`, `body_column_i32`, `str_to_json`, `emit_row`, `this_or`, `required`, `is_one_of`, `matches`, `vec_norm`, `vec_l2`, `lid_mle`, `xxhash3_vec`, `vec_dot`, `hash_vec`, `vec_add`, `vec_scale`, `vec_cosine`, `one_of_weighted`, `one_of`, `exactly_one_value`, `log_debug`, `log_warn`, `log_info`, `log_error`, `debug_repr`, `inspect`, `fft_analyze`, `type_of`, `set_or_get`.
