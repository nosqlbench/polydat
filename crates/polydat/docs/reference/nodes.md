...
The engine parity suite drives 296 coverage programs, one per node or node form, through every engine a host can choose.
...
Pure native code, the differential tier behind P3, has no lowering for these 125 nodes, which P3 runs as closure steps:

`alias_sample`, `array_at`, `array_len`, `at`, `body_column_i32`, `byte_image_extract`, `byte_slice`, `bytes_from_hash`, `cardinality`, `char_buf`, `char_image_extract`, `clamp_in`, `combinations`, `count_of`, `counter`, `csv_field`, `csv_row`, `csv_row_count`, `date_components`, `debug_repr`, `dynamic_weighted_select`, `elapsed_millis`, `emit_row`, `end_of`, `env`, `env_or`, `escape_json`, `exactly_one_value`, `fft_analyze`, `file_line_at`, `fixed_values_f64`, `fixed_values_str`, `fixed_values_u64`, `format_f64`, `format_u64`, `from_base32`, `from_base64`, `from_hex`, `hash_vec`, `hashed_line_to_string`, `hashed_lorem_extract`, `hashed_uuid`, `histribution`, `html_decode`, `html_encode`, `idx_of`, `inspect`, `is_one_of`, `is_stable`, `json_field`, `json_merge`, `json_to_str_pretty`, `json_with`, `jsonl_field`, `jsonl_row`, `jsonl_row_count`, `lid_mle`, `limit`, `log_debug`, `log_error`, `log_info`, `log_warn`, `matches`, `md5`, `mod_in`, `normalize_vector`, `number_to_words`, `one_of`, `one_of_weighted`, `partition_at`, `partition_count`, `partitions`, `pattern_match`, `pick`, `random_bool`, `random_bytes`, `random_f64`, `random_in`, `random_range`, `random_string`, `random_vector`, `reg_dot_f32`, `reg_gather_f32`, `reg_lane_f32`, `reg_lane_i16`, `reg_lane_i64`, `reg_mul_i8`, `reg_shuffle_bytes`, `reg_to_vec_f32`, `reg_with_lane_f32`, `regex_extract`, `regex_match`, `regex_replace`, `required`, `select_str`, `set_or_get`, `sha256`, `start_of`, `str_concat`, `str_eq`, `str_ne`, `str_to_json`, `streamer`, `subdivide`, `this_or`, `tmp_dir`, `to_base32`, `to_base64`, `to_hex`, `to_timestamp`, `type_of`, `u64_to_bytes`, `url_decode`, `url_encode`, `vec_add`, `vec_cosine`, `vec_dot`, `vec_l2`, `vec_norm`, `vec_scale`, `vec_to_reg_f32`, `weighted_strings`, `weighted_u64`, `xxhash3_vec`, `zero_pad_u64`.
