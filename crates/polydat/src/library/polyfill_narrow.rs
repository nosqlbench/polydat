...
fn __u8_to_u64(n: u8) -> u64 {
    n as u64
}

#[crate::polydat_node(category = Conversions)]
fn __u8_to_u32(n: u8) -> u32 {
    n as u32
}

#[crate::polydat_node(category = Conversions)]
fn __u8_to_u16(n: u8) -> u16 {
    n as u16
}

#[crate::polydat_node(category = Conversions)]
fn __u8_to_f64(n: u8) -> f64 {
    n as f64
}

#[crate::polydat_node(category = Conversions)]
fn __u16_to_u64(n: u16) -> u64 {
    n as u64
}

#[crate::polydat_node(category = Conversions)]
fn __u16_to_u32(n: u16) -> u32 {
    n as u32
}

#[crate::polydat_node(category = Conversions)]
fn __u16_to_f64(n: u16) -> f64 {
    n as f64
}

#[crate::polydat_node(category = Conversions)]
fn __i8_to_i64(n: i8) -> i64 {
    n as i64
}

#[crate::polydat_node(category = Conversions)]
fn __i8_to_i32(n: i8) -> i32 {
    n as i32
}

#[crate::polydat_node(category = Conversions)]
fn __i8_to_i16(n: i8) -> i16 {
    n as i16
}

#[crate::polydat_node(category = Conversions)]
fn __i8_to_f64(n: i8) -> f64 {
    n as f64
}

#[crate::polydat_node(category = Conversions)]
fn __i16_to_i64(n: i16) -> i64 {
    n as i64
}

#[crate::polydat_node(category = Conversions)]
fn __i16_to_i32(n: i16) -> i32 {
    n as i32
}

#[crate::polydat_node(category = Conversions)]
fn __i16_to_f64(n: i16) -> f64 {
    n as f64
}

// Every f16 is exactly representable in f32 and f64.
#[crate::polydat_node(category = Conversions)]
fn __f16_to_f32(f: half::f16) -> f32 {
    f.to_f32()
}

#[crate::polydat_node(category = Conversions)]
fn __f16_to_f64(f: half::f16) -> f64 {
    f.to_f64()
}
...
// holds without holes.
#[crate::polydat_node(category = Conversions)]
fn __u8_to_i16(n: u8) -> i16 {
    n as i16
}

#[crate::polydat_node(category = Conversions)]
fn __u8_to_i32(n: u8) -> i32 {
    n as i32
}

#[crate::polydat_node(category = Conversions)]
fn __u8_to_i64(n: u8) -> i64 {
    n as i64
}

#[crate::polydat_node(category = Conversions)]
fn __u8_to_f32(n: u8) -> f32 {
    n as f32
}

#[crate::polydat_node(category = Conversions)]
fn __u16_to_i32(n: u16) -> i32 {
    n as i32
}

#[crate::polydat_node(category = Conversions)]
fn __u16_to_i64(n: u16) -> i64 {
    n as i64
}

#[crate::polydat_node(category = Conversions)]
fn __u16_to_f32(n: u16) -> f32 {
    n as f32
}

#[crate::polydat_node(category = Conversions)]
fn __i8_to_f32(n: i8) -> f32 {
    n as f32
}

#[crate::polydat_node(category = Conversions)]
fn __i16_to_f32(n: i16) -> f32 {
    n as f32
}
...
#[crate::polydat_node(category = Conversions)]
fn __u8_to_f16(n: u8) -> half::f16 {
    half::f16::from_f32(n as f32)
}

#[crate::polydat_node(category = Conversions)]
fn __i8_to_f16(n: i8) -> half::f16 {
    half::f16::from_f32(n as f32)
}
...
fn __i64_to_i8(n: i64) -> i8 {
    if n < i8::MIN as i64 || n > i8::MAX as i64 {
        panic!(
            "__i64_to_i8: value {n} out of i8 range [{}, {}]",
            i8::MIN,
            i8::MAX
        );
    }
...
fn __i32_to_i8(n: i32) -> i8 {
    if n < i8::MIN as i32 || n > i8::MAX as i32 {
        panic!(
            "__i32_to_i8: value {n} out of i8 range [{}, {}]",
            i8::MIN,
            i8::MAX
        );
    }
...
fn __f64_to_i8(f: f64) -> i8 {
    ...
    if n < i8::MIN as f64 || n > i8::MAX as f64 {
        panic!(
            "__f64_to_i8: value {f} out of i8 range [{}, {}]",
            i8::MIN,
            i8::MAX
        );
    }
...
fn __i64_to_i16(n: i64) -> i16 {
    if n < i16::MIN as i64 || n > i16::MAX as i64 {
        panic!(
            "__i64_to_i16: value {n} out of i16 range [{}, {}]",
            i16::MIN,
            i16::MAX
        );
    }
...
fn __i32_to_i16(n: i32) -> i16 {
    if n < i16::MIN as i32 || n > i16::MAX as i32 {
        panic!(
            "__i32_to_i16: value {n} out of i16 range [{}, {}]",
            i16::MIN,
            i16::MAX
        );
    }
...
fn __f64_to_i16(f: f64) -> i16 {
    ...
    if n < i16::MIN as f64 || n > i16::MAX as f64 {
        panic!(
            "__f64_to_i16: value {f} out of i16 range [{}, {}]",
            i16::MIN,
            i16::MAX
        );
    }
...
// `__f64_to_f32`.
#[crate::polydat_node(category = Conversions)]
fn __f64_to_f16(f: f64) -> half::f16 {
    half::f16::from_f64(f)
}

#[crate::polydat_node(category = Conversions)]
fn __f32_to_f16(f: f32) -> half::f16 {
    half::f16::from_f32(f)
}

#[crate::polydat_node(category = Conversions)]
fn __u64_to_f16(n: u64) -> half::f16 {
    half::f16::from_f64(n as f64)
}
...
#[crate::polydat_node(category = Conversions)]
fn __bool_to_u8(b: bool) -> u8 {
    if b { 1 } else { 0 }
}

#[crate::polydat_node(category = Conversions)]
fn __bool_to_u16(b: bool) -> u16 {
    if b { 1 } else { 0 }
}

#[crate::polydat_node(category = Conversions)]
fn __bool_to_i8(b: bool) -> i8 {
    if b { 1 } else { 0 }
}

#[crate::polydat_node(category = Conversions)]
fn __bool_to_i16(b: bool) -> i16 {
    if b { 1 } else { 0 }
}
...
#[crate::polydat_node(category = Conversions)]
fn __u8_to_bool(n: u8) -> bool {
    n != 0
}

#[crate::polydat_node(category = Conversions)]
fn __u16_to_bool(n: u16) -> bool {
    n != 0
}

#[crate::polydat_node(category = Conversions)]
fn __i8_to_bool(n: i8) -> bool {
    n != 0
}

#[crate::polydat_node(category = Conversions)]
fn __i16_to_bool(n: i16) -> bool {
    n != 0
}
...
#[crate::polydat_node(category = Conversions)]
fn __u8_to_string(n: u8) -> String {
    n.to_string()
}

#[crate::polydat_node(category = Conversions)]
fn __u16_to_string(n: u16) -> String {
    n.to_string()
}

#[crate::polydat_node(category = Conversions)]
fn __i8_to_string(n: i8) -> String {
    n.to_string()
}

#[crate::polydat_node(category = Conversions)]
fn __i16_to_string(n: i16) -> String {
    n.to_string()
}
...
#[crate::polydat_node(category = Conversions)]
fn __f16_to_string(f: half::f16) -> String {
    format!("{:?}", f.to_f32())
}
...
#[crate::polydat_node(category = Conversions)]
fn __u8_to_bytes(n: u8) -> Vec<u8> {
    vec![n]
}

#[crate::polydat_node(category = Conversions)]
fn __u16_to_bytes(n: u16) -> Vec<u8> {
    n.to_le_bytes().to_vec()
}

#[crate::polydat_node(category = Conversions)]
fn __i8_to_bytes(n: i8) -> Vec<u8> {
    n.to_le_bytes().to_vec()
}

#[crate::polydat_node(category = Conversions)]
fn __i16_to_bytes(n: i16) -> Vec<u8> {
    n.to_le_bytes().to_vec()
}

#[crate::polydat_node(category = Conversions)]
fn __f16_to_bytes(f: half::f16) -> Vec<u8> {
...
fn __bytes_to_u8(b: &[u8]) -> u8 {
    if b.len() != 1 {
        panic!(
            "__bytes_to_u8: expected exactly 1 byte for u8, got {}",
            b.len()
        );
    }
    b[0]
...
fn __bytes_to_u16(b: &[u8]) -> u16 {
    if b.len() != 2 {
        panic!(
            "__bytes_to_u16: expected exactly 2 bytes for u16, got {}",
            b.len()
        );
    }
...
fn __bytes_to_i8(b: &[u8]) -> i8 {
    if b.len() != 1 {
        panic!(
            "__bytes_to_i8: expected exactly 1 byte for i8, got {}",
            b.len()
        );
    }
    b[0] as i8
...
fn __bytes_to_i16(b: &[u8]) -> i16 {
    if b.len() != 2 {
        panic!(
            "__bytes_to_i16: expected exactly 2 bytes for i16, got {}",
            b.len()
        );
    }
...
fn __bytes_to_f16(b: &[u8]) -> half::f16 {
    if b.len() != 2 {
        panic!(
            "__bytes_to_f16: expected exactly 2 bytes for f16, got {}",
            b.len()
        );
    }
...
fn __json_to_i8(j: &serde_json::Value) -> i8 {
    ...
    if !(i8::MIN as i64..=i8::MAX as i64).contains(&n) {
        panic!(
            "__json_to_i8: value {n} out of i8 range [{}, {}]",
            i8::MIN,
            i8::MAX
        );
    }
...
fn __json_to_i16(j: &serde_json::Value) -> i16 {
    ...
    if !(i16::MIN as i64..=i16::MAX as i64).contains(&n) {
        panic!(
            "__json_to_i16: value {n} out of i16 range [{}, {}]",
            i16::MIN,
            i16::MAX
        );
    }
...
mod tests {
    ...
    fn narrow_widenings() {
        ...
        check(
            &F16ToF32::new(),
            f16_value(1.5),
            Value::U64(1.5f32.to_bits() as u64),
        );
    }
    ...
    fn narrow_bytes_round_trip() {
        ...
        check(
            &I16ToBytes::new(),
            Value::I64(-2),
            Value::Bytes((-2i16).to_le_bytes().to_vec().into()),
        );
        check(
            &BytesToI16::new(),
            Value::Bytes((-2i16).to_le_bytes().to_vec().into()),
        ...
        check(
            &F16ToBytes::new(),
            f16_value(1.5),
            Value::Bytes(f16_bytes.clone().into()),
        );
        check(
            &BytesToF16::new(),
            Value::Bytes(f16_bytes.into()),
            f16_value(1.5),
        );
    }
    ...
    fn narrow_json_and_bool() {
        ...
        check_panics(
            &JsonToU8::new(),
            Value::Json(Arc::new(serde_json::Value::from(300_u64))),
            "exceeds u8::MAX",
        );
