...
#[polydat::polydat_node(category = ByteBuffers)]
...
fn byte_image_extract(
    input: u64,
    image_size: polydat::derive_support::Const<u64>,
    slice_size: polydat::derive_support::Const<u64>,
...
fn char_image_extract(
    ...
    image_size: polydat::derive_support::Const<u64>,
    slice_size: polydat::derive_support::Const<u64>,
    #[poly_default(0u64)] seed: polydat::derive_support::Const<u64>,
...
fn byte_slice(
    input: &[u8],
    #[poly_default(0u64)] offset: polydat::derive_support::Const<u64>,
