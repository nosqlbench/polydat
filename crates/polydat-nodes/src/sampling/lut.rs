...
use polydat::ast::{CompiledU64Op, NodeMeta, PolydatNode, Port, PortType, Slot, Value};
...
impl polydat::derive_support::PolydatSetup for LutF64 {}
...
#[polydat::polydat_node(category = Probability, jit_constants = dist_empirical_jit_constants)]
fn dist_empirical(
    input: f64,
