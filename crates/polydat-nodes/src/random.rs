...
fn random_range(
    #[poly_default(0u64)] min: polydat::derive_support::Const<u64>,
    #[poly_default(100u64)] max: polydat::derive_support::Const<u64>,
) -> u64 {
...
impl polydat::derive_support::PolydatSetup for Charset {}
...
fn random_string(
    #[poly_default("A-Za-z0-9")] charset: polydat::derive_support::Const<&str>,
    #[poly_default(8u64)] length: polydat::derive_support::Const<u64>,
...
fn random_bool(#[poly_default(0.5f64)] probability: polydat::derive_support::Const<f64>) -> bool {
...
fn hashed_lorem_extract(
    input: u64,
    min_len: polydat::derive_support::Const<u64>,
    max_len: polydat::derive_support::Const<u64>,
) -> String {
...
impl polydat::derive_support::PolydatSetup for HashedLines {}
...
fn hashed_line_to_string(
    input: u64,
    source: polydat::derive_support::Const<&str>,
